...
},{"./scripts/comments":2,"./scripts/users":3}],2:[function(require,module,exports){
/**
* @jsx React.DOM
*/
var $ = require('jquery');
var comments = React.createClass({displayName: 'comments',
  render: function () {
    return (
      React.DOM.div( {className:"comments"}, "Hello comments")
    );
  }
});
...
var users = React.createClass({displayName: 'users',
  render: function () {
    return (
      React.DOM.div( {className:"users"}, "Hello Users")
    );
  }
});
